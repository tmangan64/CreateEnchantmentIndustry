...
public class HyperExperienceOrbRenderer extends EntityRenderer<HyperExperienceOrb> {
    private static final ResourceLocation HYPER_EXPERIENCE_ORB_LOCATION = ResourceLocation.withDefaultNamespace("textures/entity/experience_orb.png");
    ...
    public void render(HyperExperienceOrb orb, float yaw, float partialTicks,
        ...
        vertex(vertexconsumer, matrix4f, -0.5F, -0.25F, red, green, 255, u1, v2, light);
        vertex(vertexconsumer, matrix4f, 0.5F, -0.25F, red, green, 255, u2, v2, light);
        vertex(vertexconsumer, matrix4f, 0.5F, 0.75F, red, green, 255, u2, v1, light);
        vertex(vertexconsumer, matrix4f, -0.5F, 0.75F, red, green, 255, u1, v1, light);
        ps.popPose();
        super.render(orb, yaw, partialTicks, ps, buffer, light);
    }

    private void vertex(VertexConsumer buffer, Matrix4f pose,
                        float x, float y,
                        int r, int g, int b,
